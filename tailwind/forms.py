...
class MessageForm(forms.Form):
    ...
    # Bootstrap4
    helper = FormHelper()
    helper.label_class = 'block text-gray-700 text-sm font-bold mb-2'
    helper.field_class = 'mb-3'
    css_container = CSSContainer(
        {"base": "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"

        }
    )
    css_container -= {
        "file": "border shadow",
        "clearablefile": "border shadow",
        "splitdatetime": "w-full"
    }
    css_container += {
        "splitdatetime": "mr-2"
    }
    css_container.option_label = "block text-gray-700 text-sm"
    css_container.radioselect = css_container.checkbox = css_container.checkboxselectmultiple = ""
    helper.css_container = css_container
    helper.layout = Layout(
        ...
        'datetime_field',
        FormActions(
            Submit('save_changes', 'Save changes', css_class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"),
            Submit('cancel', 'Cancel', css_class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"),
        )
    )
