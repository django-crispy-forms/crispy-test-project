...
class MessageForm(forms.Form):
    text_input = forms.CharField(help_text="help on a text_input", initial="test_input")
    ...
    helper.layout = Layout(
        TabHolder(
            Tab("First Tab", "text_input", "text_input_a", active=False),
            Tab("Second Tab", "text_input_b", "text_input_c", active=True),
        )
    )
